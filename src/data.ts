...
export const projects: Project[] = [
  {
    id: "tmux-one-dark-minimalist",
    name: "Tmux one dark minimalist",
    description: "A theme for tmux with the One Dark Pro colour palette",
    about:
      'Built based off of <a target="_blank" href="https://github.com/2KAbhishek/tmux2k">tmux2k</a>, and the tmux man pages',
    technologies: ["tmux"],
    link: "",
    repo: "https://github.com/ADSmith-0/tmux-one-dark-minimalist",
    colour: "#1bb91f",
  },
  {
    id: "js-cli-spinner",
    ...
    link: "",
    repo: "https://github.com/ADSmith-0/js-cli-spinner",
    colour: "#f0db4f",
  },
  {
    id: "grately",
